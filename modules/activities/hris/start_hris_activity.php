...
<div class="col-md-12" style=" background:white; border-radius: 5px;">
          <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
				  <li class=""><a href="dashboard.php?action=start_mne_activity">Start an M&E Activity</a></li>
				  <li class="active"><a href="dashboard.php?action=start_hris_activity">Start an HRIS Activity</a></li> 
                 </ul>
		   </div>
                               
                <div class="box-header with-border">
                  <h5 class="box-title">Start HRIS Activity</h5>
                </div>
<div class="col-md-4">
				...
				<div class="form-group">
				   ...
				   <div id="">
                      ...
                      <input class="form-control" name="official" id="leader" value="" placeholder="Search and Select Official's Name" type="text">
				   </div>
				   <div id="">
                      <label>Accompanying Official 2:</label>
				      <input class="form-control" name="official1" id="leader" value="" placeholder="Search and Select Official's Name" type="text" autofocus required>
			       </div>
					<div id="">
                      <label>Accompanying Official 3:</label>
				      <input class="form-control" name="official2" id="leader" placeholder="Enter Telephone Number" type="tel" autofocus required>
			       </div>
				   	<div id="">
                      <label>Accompanying Official 4:</label>
				      <input class="form-control" name="official3" id="leader" placeholder="Enter Telephone Number" type="tel" autofocus required>
			       </div>
				</div>
				<div class="form-group">
				   <div id="">
                      <label>Facility / District 1: *</label> 
                      <input class="form-control" name="facility1" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
				    <div id="">
                      <label>Facility / District 2:</label> 
...
<div class="col-md-4">
        <div class="box-body">
		        <div class="form-group">
					<div id="">
                      <label>Facility / District 3:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 4:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 5:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 6::</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 7:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 8:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 9:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 10:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 11::</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>	
				</div>
		</div>
...
<div class="col-md-4">
        <div class="box-body">
		        <div class="form-group">
					<div id="">
                      <label>Facility / District 12:</label> 
                      <input class="form-control" name="facility1" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 13:</label> 
                      <input class="form-control" name="facilty2" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 14:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
					<div id="">
                      <label>Facility / District 15:</label> 
                      <input class="form-control" name="facilty3" value="" placeholder="Search and Select the Facility's Name" type="txet">
					</div>
				</div>
				<div class="form-group">
					...
					<div id="">
                      <label>Activity Matrix (.doc/pdf):</label> 
                      <input type="file" name="tor" value="" class="form-control" style="border: 2px solid #878E63; border-radius:5px;">
					</div>
					<div id="">
