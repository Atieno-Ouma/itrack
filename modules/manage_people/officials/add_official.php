...
<div class="col-md-12" style=" background:white; border-radius: 5px;">
          <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
				  <li class=""><a href="dashboard.php?action=people">Add Focal Person</a></li>
				  <li class="active"><a href="dashboard.php?action=add_official">Add Officer</a></li> 
                 </ul>
				</div>
                               
                <div class="box-header with-border">
                  <h5 class="box-title">Add Officer</h5>
                </div>
<div class="col-md-4">
