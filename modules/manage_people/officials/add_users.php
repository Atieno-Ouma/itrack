...
<div class="col-md-12" style=" background:white; border-radius: 5px;">
          <div class="nav-tabs-custom">
             <ul class="nav nav-tabs">
				  <li class="active"><a href="dashboard.php?action=add_users">Add Focal Person</a></li>
				  <li class=""><a href="dashboard.php?action=add_users">Add Official</a></li> 
                  </ul>
				</div>
                               
                <div class="box-header with-border">
                  <h4 class="box-title">Add a District/ Institution HRIS User</h4>
                </div>
<div class="col-md-4">
				<form name="" method="post" action="">
				   ...
				   <div id="">
                      ...
                      <input class="form-control" name="photo" id="expense_date"  type="file">
				   </div>
				   <div id="">
